...
When **reviewing recordings** in Halvern, we recommend using **computer speakers** or **wired headphones** rather than Bluetooth headphones for accurate playback.
...
1. **Halvern records at 48kHz** (professional audio standard)
...
- ❌ **Reviewing Halvern recordings** - Use wired/speakers instead
...
### This is Not a Halvern Bug

The issue is in **macOS's Bluetooth audio stack**, not in Halvern's recording engine.
...
**A**: This is a macOS/Bluetooth limitation, not a Halvern bug. We've correctly recorded at 48kHz.
...
**A**: Yes! Halvern now shows a warning when Bluetooth headphones are active during playback.
