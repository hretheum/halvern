...
function MeetingDetailsContent() {
  ...
  // Claimed by the invalid-meeting branch below before it reports a page view.
  const invalidPageViewTrackedRef = useRef(false);
  ...
  useEffect(() => {
    ...
    if (!meetingId || meetingId === 'intro-call') {
      ...
      if (!invalidPageViewTrackedRef.current) {
        invalidPageViewTrackedRef.current = true;
