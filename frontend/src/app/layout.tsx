...
export default function RootLayout({
  ...
  useEffect(() => {
    ...
    const unlisten = listen('request-recording-toggle', () => {
      ...
      if (showOnboarding) {
        ...
        // The start hook lives on the recording screen; navigate there and
        // let it pick up the auto-start flag on mount.
  ...
  // theme class onto <html> from a blocking script before React hydrates, so the
