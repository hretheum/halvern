  ...
  return (
    ...
    >
      <div className="flex flex-col items-center space-y-10">
        ...
        {/* Features Card */}
        <div className="w-full max-w-md bg-card rounded-lg border border-border shadow-xs p-6 space-y-4">
        ...
        <div className="w-full max-w-xs space-y-3">
          ...
          <p className="text-sm text-center text-muted-foreground">Takes less than 3 minutes</p>
        </div>
      </div>
    </OnboardingContainer>
  );
