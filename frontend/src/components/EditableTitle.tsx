  ...
  return isEditing ? (
    <div className="flex-1">
      <textarea
        ...
        className="text-2xl font-bold bg-muted border border-border focus:outline-hidden focus:ring-2 focus:ring-blue-500 rounded px-3 py-1 w-full resize-none overflow-hidden"
    ...
    <div className="group flex items-center space-x-2 flex-1">
      ...
      <div className="flex space-x-1">
        ...
        {onDelete && (
          <button 
            onClick={onDelete}
            className="opacity-0 group-hover:opacity-100 transition-opacity duration-200 p-1 hover:bg-accent rounded text-red-600 dark:text-red-400"
