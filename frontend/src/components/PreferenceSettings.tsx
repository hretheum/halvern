...
export function PreferenceSettings() {
  ...
  useEffect(() => {
    loadPreferences();
    // No ref reset here: a fresh tab visit mounts a fresh component instance,
    // whose ref is already false. Resetting on every effect run made strict
    // mode's second run track the view again.
  }, [loadPreferences]);
  ...
  return (
    <div className="space-y-6">
      {/* Appearance first: it is the setting people reach for soonest, and the
          one that changes how everything below it looks. Data locations live
          under Advanced. */}
      <AppearanceSetting />
