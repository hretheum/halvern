...
import { ChevronDown, Sparkles, Settings, Loader2, FileText, Check, Square } from 'lucide-react';
...
export function SummaryGeneratorButtonGroup({
  ...
  return (
    // Visual grammar: the one primary action is filled, secondary actions are
    // ghost, selectors are outline with a chevron, Stop is destructive. A fused
    // group made all of these read as tabs.
