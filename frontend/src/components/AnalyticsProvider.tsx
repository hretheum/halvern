...
export default function AnalyticsProvider({ children }: AnalyticsProviderProps) {
  ...
  useEffect(() => {
    // Prevent duplicate initialization in React StrictMode. The claim must be
    // synchronous: it used to be made deep inside initAnalytics, after several
    // awaits, so both strict-mode runs passed this check and the session,
    // identify and launch events all fired twice.
