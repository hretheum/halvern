    ...
    >
      <div className="flex items-center gap-2 px-3 py-2.5 border-b border-border">
        ...
        <input
          ...
          className="flex-1 text-sm text-foreground bg-transparent border-none outline-hidden placeholder:text-muted-foreground"
        />
      </div>
      ...
      <div className="max-h-80 overflow-y-auto py-1">
            ...
            {recentsResolved.map((opt) => (
              <button
                ...
                className={`flex w-full items-center justify-between px-3 py-1.5 text-sm hover:bg-accent text-left ${
                  value === opt.code ? "text-blue-600 dark:text-blue-400 font-medium" : "text-foreground"
                }`}
              >
                <span>
                  {opt.label}{" "}
                ...
                {value === opt.code && <span className="text-blue-600 dark:text-blue-400" aria-hidden="true">✓</span>}
              </button>
            ))}
        ...
        {showAuto && (
          <button
            ...
            className={`flex w-full items-center justify-between px-3 py-1.5 text-sm hover:bg-accent text-left ${
              value === null ? "text-blue-600 dark:text-blue-400 font-medium" : "text-foreground"
            }`}
          >
            ...
            {value === null && <span className="text-blue-600 dark:text-blue-400" aria-hidden="true">✓</span>}
          </button>
        )}
