  ...
  return (
    <>
      <div className="space-y-4">
        ...
        <div className="flex items-start gap-2 p-2 rounded border bg-info-bg border-info-border">
          <Info className="w-4 h-4 mt-0.5 shrink-0 text-info-text" />
          <div className="text-xs text-info-text">
            <p className="mb-1">
              Your meetings, transcripts and recordings never leave this machine.
            </p>
            <p>
              This build has no analytics endpoint compiled in, so it cannot send
              anything even with the switch on.
            </p>
          </div>
        </div>
      </div>
