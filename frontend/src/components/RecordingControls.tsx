  ...
  useEffect(() => {
    ...
    const setupListeners = async () => {
      try {
        ...
        unsubscribes.push(transcriptErrorUnsubscribe);
        ...
        unsubscribes.push(transcriptionErrorUnsubscribe);
  ...
  return (
    <TooltipProvider>
      <div className="flex flex-col space-y-2">
                    ...
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <button
                          ...
                          className={`w-13 h-13 flex items-center justify-center ${isStarting || isProcessing || isValidatingModel ? 'bg-muted-foreground/40' : 'bg-recording hover:opacity-90'
                      ...
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <button
                            ...
                            className={`w-13 h-13 flex items-center justify-center ${isPausing || isResuming || isStopping
                      ...
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <button
                            ...
                            className={`w-13 h-13 flex items-center justify-center ${isStopping || isPausing || isResuming ? 'bg-muted-foreground/40' : 'bg-recording hover:opacity-90'
                              } rounded-full text-white transition-colors relative`}
                          >
        ...
        {/* Device error alert */}
        {deviceError && (
          <Alert variant="destructive" className="mt-4 border-red-300 dark:border-red-800 bg-red-50 dark:bg-red-950/40">
            <AlertCircle className="h-5 w-5 text-red-600 dark:text-red-400" />
            <button
              onClick={() => setDeviceError(null)}
              className="absolute right-3 top-3 text-red-600 dark:text-red-400 hover:text-red-800 transition-colors"
