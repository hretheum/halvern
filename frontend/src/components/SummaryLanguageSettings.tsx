  ...
  return (
    <div className="bg-card rounded-lg border border-border p-6 shadow-xs relative">
      ...
      <p className="text-sm text-muted-foreground mb-4">
        A pinned language is used for every summary, though you can still pick a different
        language for an individual meeting. Without a pin, the language is detected from the
        transcript.
      </p>
