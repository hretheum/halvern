...
export function HomebrewDatabaseDetector({ onImportSuccess, onDecline }: HomebrewDatabaseDetectorProps) {
  ...
  return (
    <div className="mb-4 p-4 bg-blue-50 dark:bg-blue-950/40 border-2 border-blue-300 dark:border-blue-800 rounded-lg">
      <div className="flex items-start gap-3">
        <Database className="h-6 w-6 text-blue-600 dark:text-blue-400 mt-0.5 shrink-0" />
        <div className="flex-1">
          ...
          <div className="flex gap-2">
            ...
            <button
              onClick={handleNo}
              disabled={isImporting}
              className="flex-1 px-4 py-2 border-2 border-blue-400 text-blue-700 dark:text-blue-300 rounded-lg hover:bg-blue-100 dark:hover:bg-blue-900/50 disabled:bg-muted disabled:cursor-not-allowed transition-colors"
            >
              No, Browse Manually
            </button>
          </div>
