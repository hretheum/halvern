...
> **Status note (August 2026).** This document predates the coverage audit and
> is partly historical: `lib_old_complex.rs`, its headline item, no longer
> exists. The dead-code question it opens is now tracked with evidence and
> forced dispositions in
> [TEST_COVERAGE_AUDIT.md](TEST_COVERAGE_AUDIT.md) (Audit 2), which supersedes
> this file for anything unreachable-code related. Kept for the architectural
> observations it still makes.
